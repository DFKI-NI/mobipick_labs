...
class Simulation:
    ...
    def __init__(self, item_locations: Dict[Item, Location], table_count: int) -> None:
        ...
        self.domain.create_search_at_action(self.env.search_at, ["home", "observe100cm_right", "transport"], False)
        self.domain.create_search_tool_action(self.env.search_tool)
        self.domain.create_search_klt_action(self.env.search_klt)
        self.domain.create_conclude_tool_search_action(self.env.conclude_tool_search, ["table_1", "table_2", "table_3"])
        self.domain.create_conclude_klt_search_action(self.env.conclude_klt_search, ["table_1", "table_2", "table_3"])
